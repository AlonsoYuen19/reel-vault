...
mixin _$Cast {
 ...
 int get id; String get name;@JsonKey(name: 'profile_path') String? get profilePath;@JsonKey(name: 'character') String? get character;
...
@useResult
$Res call({
 int id, String name,@JsonKey(name: 'profile_path') String? profilePath,@JsonKey(name: 'character') String? character
});
...
/// Create a copy of Cast
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? profilePath = freezed,Object? character = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'profile_path')  String? profilePath, @JsonKey(name: 'character')  String? character)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Cast() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name, @JsonKey(name: 'profile_path')  String? profilePath, @JsonKey(name: 'character')  String? character)  $default,) {final _that = this;
switch (_that) {
case _Cast():
return $default(_that.id,_that.name,_that.profilePath,_that.character);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name, @JsonKey(name: 'profile_path')  String? profilePath, @JsonKey(name: 'character')  String? character)?  $default,) {final _that = this;
switch (_that) {
case _Cast() when $default != null:
return $default(_that.id,_that.name,_that.profilePath,_that.character);case _:
  return null;
...
class _Cast implements Cast {
  const _Cast({required this.id, required this.name, @JsonKey(name: 'profile_path') this.profilePath, @JsonKey(name: 'character') this.character});
...
/// Create a copy of Cast
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? profilePath = freezed,Object? character = freezed,}) {
  return _then(_Cast(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,profilePath: freezed == profilePath ? _self.profilePath : profilePath // ignore: cast_nullable_to_non_nullable
